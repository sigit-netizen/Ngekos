...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-6 overflow-hidden"
    ...
    <div class="max-w-md w-full relative">
        <div
            class="glass border border-white/40 shadow-2xl rounded-3xl p-10 text-center transform transition-all duration-500">
            ...
            <p class="text-gray-500 text-sm leading-relaxed mb-6">
                Maaf, pendaftaran akun dengan email <span
                    class="text-red-600 font-bold">{{ $pendingUser->email }}</span>
            ...
            <div class="bg-red-50/70 rounded-2xl p-5 mb-6 text-left border border-red-100">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex gap-2">
                        <span class="text-gray-500 font-bold shrink-0">Nama:</span>
                        <span class="text-gray-800 font-bold">{{ $pendingUser->name }}</span>
                    </div>
                    <div class="flex gap-2">
                        <span class="text-gray-500 font-bold shrink-0">NIK:</span>
                        <span class="text-gray-800 font-bold">{{ $pendingUser->nik }}</span>
                    </div>
                    <div class="mt-3 pt-3 border-t border-red-200">
                        <span class="text-xs font-black text-red-700 uppercase tracking-wider block mb-1">Alasan:</span>
                        <p class="text-gray-700 text-sm leading-relaxed">{{ $pendingUser->rejection_reason }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-blue-700 text-xs leading-relaxed">
                            Silakan periksa data Anda kembali lalu lakukan <strong>pendaftaran ulang</strong> dengan
                            data yang benar.
                        </p>
                    </div>
                </div>
        ...
        <p class="text-white/60 text-[10px] text-center mt-8 font-bold uppercase tracking-[0.3em]">
            &copy; 2026 Ngekos.id • Verification System
        </p>
    </div>
