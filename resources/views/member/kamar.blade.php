        ...
        @else
            ...
            <div class="space-y-6" data-aos="fade-up">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-50/50">
                                    <th class="px-8 py-6 text-[11px] font-black text-gray-400 uppercase tracking-widest">No.
                                        Kamar
                                    </th>
                                    ...
                                    <tr class="hover:bg-gray-50/80 transition-colors group">
                                        <td class="px-8 py-6">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p class="font-black text-gray-900" x-text="'Unit ' + kamar.nomor_kamar">
                                                    </p>
                                                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-tight"
                                                        x-text="'ID: #UNIT-0' + (index + 1 + (currentPage - 1) * itemsPerPage)">
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-8 py-6">
                                            <div class="flex items-baseline gap-1">
                                                ...
                                                <span class="text-[10px] font-bold text-gray-400 uppercase"
                                                    x-text="'/ ' + (kamar.durasi_sewa || 1) + ' ' + (kamar.tipe_durasi || 'bulan')"></span>
                                            </div>
                                        </td>
                                            ...
                                            <div @click="openFasilitasModal(kamar)"
                                                ...
                                                <div class="flex flex-wrap gap-1">
                                                    ...
                                                    <template x-if="!kamar.fasilitas || kamar.fasilitas.length === 0">
                                                        <span class="text-[10px] text-gray-300 italic">Belum ada
                                                            fasilitas...</span>
                                                    </template>
                                                </div>
                                                <div
                ...
                <div class="grid grid-cols-1 gap-4 md:hidden">
                    <template x-for="(kamar, index) in pagedKamars" :key="kamar.id">
                        <div
                            class="bg-white rounded-3xl p-5 border-2 border-gray-100 shadow-sm relative group active:scale-[0.98] transition-transform">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <template x-if="kamar.status === 'tersedia'">
                                            <span
                                                class="text-[9px] font-black text-emerald-500 uppercase tracking-widest">Kosong</span>
                                        </template>
                                        <template x-if="kamar.status === 'terisi'">
                                            <span
                                                class="text-[9px] font-black text-rose-500 uppercase tracking-widest">Terisi</span>
                                        </template>
                                    </div>
                                </div>
                            ...
                            <div
                                class="flex items-center justify-between mb-4 bg-gray-50/50 p-3 rounded-2xl border border-gray-100">
                                <div>
                                    <span
                                        class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-0.5">Harga
                                        Sewa</span>
                                    <div class="flex items-baseline gap-1">
                                ...
                                <div @click="openFasilitasModal(kamar)" class="text-right cursor-pointer">
                                    <span
                                        class="text-[9px] font-black text-[#36B2B2] uppercase tracking-widest block mb-1">Fasilitas</span>
                                    <div class="flex -space-x-2 justify-end">
                                        <template x-for="(fas, i) in (kamar.fasilitas || []).slice(0, 3)" :key="i">
                                            <div
                                                ...
                                                <span class="text-[8px] font-black text-gray-600"
                                                    x-text="fas.nama_fasilitas.substring(0,1)"></span>
                                            </div>
                                        </template>
                                        <template x-if="kamar.fasilitas && kamar.fasilitas.length > 3">
                                            <div
                                                class="w-6 h-6 rounded-full bg-[#36B2B2] text-white border border-white flex items-center justify-center shadow-sm">
                                                <span class="text-[8px] font-black"
                                                    x-text="'+' + (kamar.fasilitas.length - 3)"></span>
                                            </div>
                                        </template>
                                        <template x-if="!kamar.fasilitas || kamar.fasilitas.length === 0">
                            ...
                            <button @click="openFasilitasModal(kamar)"
                                class="w-full py-2.5 bg-gray-50 border border-gray-100 rounded-xl text-[10px] font-black text-gray-500 uppercase tracking-widest hover:bg-gray-100 transition-colors">
            ...
            <form @click.away="showAddModal = false" action="{{ route('admin.kamar.store') }}" method="POST"
                ...
                <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-5 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1.5 ml-1">Durasi</label>
                            <input type="number" name="durasi_sewa" x-model="formData.durasi_sewa" required min="1"
                                class="w-full px-5 py-2.5 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-[#36B2B2] outline-none transition-all font-black text-gray-800 text-sm">
                        </div>
                        <div>
                            <label
                                class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1.5 ml-1">Satuan</label>
                ...
                <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-5 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1.5 ml-1">Durasi</label>
                            <input type="number" name="durasi_sewa" x-model="editFormData.durasi_sewa" required min="1"
                                class="w-full px-5 py-2.5 bg-gray-50 border-2 border-gray-100 rounded-xl focus:border-indigo-600 outline-none transition-all font-black text-gray-800 text-sm">
                        </div>
                        <div>
                            <label
