...
<div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-sm border border-white/50 mb-8" data-aos="fade-up">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Halaman Pengaturan</h1>
    <p class="text-gray-500">File view untuk halaman ini berada di admin/pengaturan.blade.php</p>
</div>
